...
class simulateOnlineData():
	def __init__(self, dimension, iterations, articles, users, 
		...
		#self.W = np.identity(len(self.users))
...
if __name__ == '__main__':
	...
	algorithms['LinUCB_SelectUser'] = LinUCB_SelectUserAlgorithm(dimension = dimension, alpha = alpha, lambda_ = lambda_, n = n_users)	
	algorithms['AsyncCoLin_SelectUser'] = AsyCoLinUCB_SelectUserAlgorithm(dimension=dimension, alpha = alpha, lambda_ = lambda_, n = n_users, W = simExperiment.getW())
	
	#algorithms['LinUCB_RandomUser'] = LinUCBAlgorithm(dimension = dimension, alpha = alpha, lambda_ = lambda_, n = n_users)
	#algorithms['AsyncCoLin_RandomUser'] = AsyCoLinUCBAlgorithm(dimension=dimension, alpha = alpha, lambda_ = lambda_, n = n_users, W = simExperiment.getW())
